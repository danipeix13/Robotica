...
void SpecificWorker::draw_laser(const RoboCompLaser::TLaserData &ldata, RoboCompFullPoseEstimation::FullPoseEuler bState) // robot coordinates
{
...
std::tuple<float, float> SpecificWorker::world2robot(RoboCompFullPoseEstimation::FullPoseEuler bState)
{   //TODO: transpose
