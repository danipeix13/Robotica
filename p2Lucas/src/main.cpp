...
/** \mainpage RoboComp::chocachoa2
 *
 * \section intro_sec Introduction
 *
 * The chocachoa2 component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/chocachoa2 --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class chocachoa2 : public RoboComp::Application
{
public:
	chocachoa2 (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::chocachoa2::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::chocachoa2 app(prefix, startup_check_flag);
