...
/** \mainpage RoboComp::miCompo
 *
 * \section intro_sec Introduction
 *
 * The miCompo component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/miCompo --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class miCompo : public RoboComp::Application
{
public:
	miCompo (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::miCompo::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::miCompo app(prefix, startup_check_flag);
